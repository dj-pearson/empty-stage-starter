...
│   ├── RootView.swift      # Auth routing (loading/unauth/auth)
│   └── AppState.swift      # Central state (foods, kids, recipes, etc.)
...
├── Utilities/              # Helpers (date formatters, password validation)
