...
OWNED='^(src/lib/comparison-|src/pages/Compare\.tsx|src/pages/ComparisonPage\.|src/lib/robots-txt\.test\.ts|src/lib/contentDecay\.test\.ts|src/lib/seo/|src/lib/seoLocales\.test\.tsx|src/components/admin/seo/SeoCannibalizationTab\.tsx|src/components/admin/seo/useSeoCannibalization\.ts|src/components/admin/seo/SeoIndexCoverageTab\.tsx|src/components/admin/seo/useSeoIndexCoverage\.ts|src/lib/prerenderManifest\.test\.ts)'
