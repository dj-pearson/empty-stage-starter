...
const ALLOWED = new Map([
  ...
  ['components/BarcodeScannerScreen.tsx', 'KEPT 2026-09-03: has its own passing test (BarcodeScannerScreen.test.tsx); check against the live scanner path before removing.'],
  ...
  ['components/HarmonizedFoodDisplay.tsx', 'KEPT 2026-09-03: has its own passing test (HarmonizedFoodDisplay.test.tsx).'],
  ['components/KidMealVoting.tsx', 'KEPT 2026-09-03: a BUILT feature never mounted. Reads meal_votes, voting_achievements and profiles, backed by migration 20251110000004_meal_voting.sql. Needs a story to mount it, not deletion.'],
