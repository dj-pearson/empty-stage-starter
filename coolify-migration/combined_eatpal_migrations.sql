-- ============================================
-- EatPal Combined Migrations
-- Generated: 2025-12-08 22:56:11
-- Total Migrations: 88
-- ============================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20250109000000_add_featured_image_to_blog.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE INDEX IF NOT EXISTS idx_blog_posts_published_at ON blog_posts(published_at);
            ...
            INSERT INTO _migrations (filename, success) VALUES ('20250109000000_add_featured_image_to_blog.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20250109000000_add_featured_image_to_blog.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20250109000000_add_featured_image_to_blog.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20250109000000_add_featured_image_to_blog.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20250112000000_blog_advanced_features.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION refresh_blog_materialized_views IS 'Refresh all blog-related materialized views for updated analytics';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20250112000000_blog_advanced_features.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20250112000000_blog_advanced_features.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20250112000000_blog_advanced_features.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20250112000000_blog_advanced_features.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008012402_c8f3da2d-2ed2-4cce-8478-2fd697a46260.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE TRIGGER update_recipes_updated_at
  ...
  EXECUTE FUNCTION public.update_updated_at_column();
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008012402_c8f3da2d-2ed2-4cce-8478-2fd697a46260.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008012402_c8f3da2d-2ed2-4cce-8478-2fd697a46260.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008012402_c8f3da2d-2ed2-4cce-8478-2fd697a46260.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008012402_c8f3da2d-2ed2-4cce-8478-2fd697a46260.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008013812_d9ef4871-2f4c-4f46-bd5c-eb6502b88b5c.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE INDEX idx_nutrition_name ON public.nutrition(name);
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008013812_d9ef4871-2f4c-4f46-bd5c-eb6502b88b5c.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008013812_d9ef4871-2f4c-4f46-bd5c-eb6502b88b5c.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008013812_d9ef4871-2f4c-4f46-bd5c-eb6502b88b5c.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008013812_d9ef4871-2f4c-4f46-bd5c-eb6502b88b5c.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008013822_e4b47634-8a88-4308-83e0-40b79e62126a.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008013822_e4b47634-8a88-4308-83e0-40b79e62126a.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008013822_e4b47634-8a88-4308-83e0-40b79e62126a.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008013822_e4b47634-8a88-4308-83e0-40b79e62126a.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008013822_e4b47634-8a88-4308-83e0-40b79e62126a.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008013843_23f5522d-3b4f-4e52-8b61-b356c7bf8bd6.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008013843_23f5522d-3b4f-4e52-8b61-b356c7bf8bd6.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008013843_23f5522d-3b4f-4e52-8b61-b356c7bf8bd6.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008013843_23f5522d-3b4f-4e52-8b61-b356c7bf8bd6.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008013843_23f5522d-3b4f-4e52-8b61-b356c7bf8bd6.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008013852_4b7a7057-56d0-4de1-947f-3606ee7e56c2.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008013852_4b7a7057-56d0-4de1-947f-3606ee7e56c2.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008013852_4b7a7057-56d0-4de1-947f-3606ee7e56c2.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008013852_4b7a7057-56d0-4de1-947f-3606ee7e56c2.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008013852_4b7a7057-56d0-4de1-947f-3606ee7e56c2.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008015952_75b210cc-eba3-4a02-97c9-0cad18462aa6.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ON CONFLICT (user_id, role) DO NOTHING;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008015952_75b210cc-eba3-4a02-97c9-0cad18462aa6.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008015952_75b210cc-eba3-4a02-97c9-0cad18462aa6.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008015952_75b210cc-eba3-4a02-97c9-0cad18462aa6.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008015952_75b210cc-eba3-4a02-97c9-0cad18462aa6.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008023303_bbb977b2-65ba-44b0-a13d-396ac2f81c9e.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
GRANT EXECUTE ON FUNCTION public.deduct_food_quantity TO authenticated;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008023303_bbb977b2-65ba-44b0-a13d-396ac2f81c9e.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008023303_bbb977b2-65ba-44b0-a13d-396ac2f81c9e.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008023303_bbb977b2-65ba-44b0-a13d-396ac2f81c9e.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008023303_bbb977b2-65ba-44b0-a13d-396ac2f81c9e.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008023632_948365b0-0399-43db-a3fa-2c715f8321e5.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
GRANT EXECUTE ON FUNCTION public.is_food_safe_for_kid TO authenticated;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008023632_948365b0-0399-43db-a3fa-2c715f8321e5.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008023632_948365b0-0399-43db-a3fa-2c715f8321e5.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008023632_948365b0-0399-43db-a3fa-2c715f8321e5.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008023632_948365b0-0399-43db-a3fa-2c715f8321e5.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008023643_a4d9b74e-39c5-4bc5-b0e5-81894fe991f8.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008023643_a4d9b74e-39c5-4bc5-b0e5-81894fe991f8.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008023643_a4d9b74e-39c5-4bc5-b0e5-81894fe991f8.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008023643_a4d9b74e-39c5-4bc5-b0e5-81894fe991f8.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008023643_a4d9b74e-39c5-4bc5-b0e5-81894fe991f8.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008024530_b810b648-92cd-40a7-aef2-882363055120.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
INSERT INTO public.ai_settings (
  ...
  4096
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008024530_b810b648-92cd-40a7-aef2-882363055120.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008024530_b810b648-92cd-40a7-aef2-882363055120.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008024530_b810b648-92cd-40a7-aef2-882363055120.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008024530_b810b648-92cd-40a7-aef2-882363055120.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008025307_8faf3224-9a40-415e-9176-ccaa98641861.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ADD COLUMN profile_picture_url text;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008025307_8faf3224-9a40-415e-9176-ccaa98641861.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008025307_8faf3224-9a40-415e-9176-ccaa98641861.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008025307_8faf3224-9a40-415e-9176-ccaa98641861.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008025307_8faf3224-9a40-415e-9176-ccaa98641861.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008025502_a2c7d4dd-23dc-4b3c-ace1-8c1eb4361bdc.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE INDEX idx_kids_date_of_birth ON public.kids(date_of_birth);
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008025502_a2c7d4dd-23dc-4b3c-ace1-8c1eb4361bdc.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008025502_a2c7d4dd-23dc-4b3c-ace1-8c1eb4361bdc.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008025502_a2c7d4dd-23dc-4b3c-ace1-8c1eb4361bdc.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008025502_a2c7d4dd-23dc-4b3c-ace1-8c1eb4361bdc.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008030206_c9b6c7c6-6d3a-4a04-b000-ad390c8eff9f.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ADD COLUMN package_quantity text;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008030206_c9b6c7c6-6d3a-4a04-b000-ad390c8eff9f.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008030206_c9b6c7c6-6d3a-4a04-b000-ad390c8eff9f.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008030206_c9b6c7c6-6d3a-4a04-b000-ad390c8eff9f.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008030206_c9b6c7c6-6d3a-4a04-b000-ad390c8eff9f.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008035425_74570939-d012-4a64-b5f0-649f6c8c7b35.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE TRIGGER update_profiles_updated_at
  ...
  EXECUTE FUNCTION public.update_updated_at_column();
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008035425_74570939-d012-4a64-b5f0-649f6c8c7b35.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008035425_74570939-d012-4a64-b5f0-649f6c8c7b35.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008035425_74570939-d012-4a64-b5f0-649f6c8c7b35.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008035425_74570939-d012-4a64-b5f0-649f6c8c7b35.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008035758_e86c8db4-3460-43e4-b9c5-e03b5ca24f29.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008035758_e86c8db4-3460-43e4-b9c5-e03b5ca24f29.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008035758_e86c8db4-3460-43e4-b9c5-e03b5ca24f29.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008035758_e86c8db4-3460-43e4-b9c5-e03b5ca24f29.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008035758_e86c8db4-3460-43e4-b9c5-e03b5ca24f29.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008035900_41c8b71a-5c17-4777-8bc1-fc1e0825a7a3.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE POLICY "Household members can delete grocery items"
  ...
  USING (household_id = public.get_user_household_id(auth.uid()));
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008035900_41c8b71a-5c17-4777-8bc1-fc1e0825a7a3.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008035900_41c8b71a-5c17-4777-8bc1-fc1e0825a7a3.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008035900_41c8b71a-5c17-4777-8bc1-fc1e0825a7a3.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008035900_41c8b71a-5c17-4777-8bc1-fc1e0825a7a3.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008121540_9fd634cb-b47d-4035-8ac4-4d0c53b62c8d.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
END $$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008121540_9fd634cb-b47d-4035-8ac4-4d0c53b62c8d.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008121540_9fd634cb-b47d-4035-8ac4-4d0c53b62c8d.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008121540_9fd634cb-b47d-4035-8ac4-4d0c53b62c8d.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008121540_9fd634cb-b47d-4035-8ac4-4d0c53b62c8d.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008140000_add_onboarding_to_profiles.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
WHERE onboarding_completed IS NULL OR onboarding_completed = FALSE;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008140000_add_onboarding_to_profiles.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008140000_add_onboarding_to_profiles.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008140000_add_onboarding_to_profiles.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008140000_add_onboarding_to_profiles.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008141000_create_subscriptions_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE TRIGGER update_user_subscriptions_updated_at
  ...
  EXECUTE FUNCTION update_updated_at_column();
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008141000_create_subscriptions_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008141000_create_subscriptions_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008141000_create_subscriptions_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008141000_create_subscriptions_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008142000_create_leads_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ON CONFLICT DO NOTHING;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008142000_create_leads_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008142000_create_leads_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008142000_create_leads_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008142000_create_leads_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008143000_create_social_posts_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ON CONFLICT DO NOTHING;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008143000_create_social_posts_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008143000_create_social_posts_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008143000_create_social_posts_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008143000_create_social_posts_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008144000_create_blog_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ON CONFLICT DO NOTHING;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008144000_create_blog_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008144000_create_blog_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008144000_create_blog_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008144000_create_blog_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008145000_create_email_marketing_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ON CONFLICT DO NOTHING;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008145000_create_email_marketing_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008145000_create_email_marketing_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008145000_create_email_marketing_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008145000_create_email_marketing_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008150000_create_food_tracking_features.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
GROUP BY k.id, k.name, f.id, f.name;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008150000_create_food_tracking_features.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008150000_create_food_tracking_features.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008150000_create_food_tracking_features.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008150000_create_food_tracking_features.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008202537_abaf0cfc-6afd-4141-89db-1fbde08a0be0.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008202537_abaf0cfc-6afd-4141-89db-1fbde08a0be0.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008202537_abaf0cfc-6afd-4141-89db-1fbde08a0be0.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008202537_abaf0cfc-6afd-4141-89db-1fbde08a0be0.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008202537_abaf0cfc-6afd-4141-89db-1fbde08a0be0.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008203700_13e32f11-8e5a-4361-bd61-bfdcb38ad9bd.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008203700_13e32f11-8e5a-4361-bd61-bfdcb38ad9bd.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008203700_13e32f11-8e5a-4361-bd61-bfdcb38ad9bd.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008203700_13e32f11-8e5a-4361-bd61-bfdcb38ad9bd.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008203700_13e32f11-8e5a-4361-bd61-bfdcb38ad9bd.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251008205036_84aa8701-4e4e-45aa-a2df-22f40ea5b683.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251008205036_84aa8701-4e4e-45aa-a2df-22f40ea5b683.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251008205036_84aa8701-4e4e-45aa-a2df-22f40ea5b683.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251008205036_84aa8701-4e4e-45aa-a2df-22f40ea5b683.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251008205036_84aa8701-4e4e-45aa-a2df-22f40ea5b683.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251009013519_73dc92eb-0536-415c-aab4-27eeef0b5679.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN public.nutrition.barcode IS 'UPC/EAN barcode for product identification and quick lookups';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251009013519_73dc92eb-0536-415c-aab4-27eeef0b5679.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251009013519_73dc92eb-0536-415c-aab4-27eeef0b5679.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251009013519_73dc92eb-0536-415c-aab4-27eeef0b5679.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251009013519_73dc92eb-0536-415c-aab4-27eeef0b5679.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251009160000_add_social_content_versions.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN social_accounts.is_global IS 'If true, this is a global webhook that receives all posts regardless of platform';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251009160000_add_social_content_versions.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251009160000_add_social_content_versions.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251009160000_add_social_content_versions.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251009160000_add_social_content_versions.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010151519_f7548433-05f9-4d84-8c6e-f86ed7a731f3.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ALTER TABLE social_accounts ALTER COLUMN platform DROP NOT NULL;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010151519_f7548433-05f9-4d84-8c6e-f86ed7a731f3.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010151519_f7548433-05f9-4d84-8c6e-f86ed7a731f3.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010151519_f7548433-05f9-4d84-8c6e-f86ed7a731f3.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010151519_f7548433-05f9-4d84-8c6e-f86ed7a731f3.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010200227_03548bf8-efb9-4405-b3c3-bf50f25dad2d.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN public.kids.flavor_preferences IS 'Array of preferred flavors like sweet, salty, mild, savory, tangy, spicy';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010200227_03548bf8-efb9-4405-b3c3-bf50f25dad2d.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010200227_03548bf8-efb9-4405-b3c3-bf50f25dad2d.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010200227_03548bf8-efb9-4405-b3c3-bf50f25dad2d.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010200227_03548bf8-efb9-4405-b3c3-bf50f25dad2d.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010220000_link_planner_food_tracker.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW recipe_success_stats IS 'Shows recipe-level success metrics';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010220000_link_planner_food_tracker.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010220000_link_planner_food_tracker.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010220000_link_planner_food_tracker.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010220000_link_planner_food_tracker.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010221000_smart_grocery_restock.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW grocery_list_with_context IS 'Grocery list with pantry context and smart sorting';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010221000_smart_grocery_restock.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010221000_smart_grocery_restock.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010221000_smart_grocery_restock.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010221000_smart_grocery_restock.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010230000_rate_limiting_system.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW rate_limit_analytics IS 'Analytics view for monitoring rate limit usage';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010230000_rate_limiting_system.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010230000_rate_limiting_system.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010230000_rate_limiting_system.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010230000_rate_limiting_system.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010231000_performance_indexes.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON INDEX idx_recipes_food_ids IS 'Optimizes recipe search by ingredients';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010231000_performance_indexes.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010231000_performance_indexes.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010231000_performance_indexes.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010231000_performance_indexes.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010232000_automated_backups.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW backup_statistics IS 'Aggregated backup statistics per user';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010232000_automated_backups.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010232000_automated_backups.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010232000_automated_backups.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010232000_automated_backups.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010233000_email_automation.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW automation_email_statistics IS 'Email campaign performance metrics';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010233000_email_automation.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010233000_email_automation.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010233000_email_automation.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010233000_email_automation.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010234000_admin_analytics.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION create_admin_notification IS 'Create a new admin notification';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010234000_admin_analytics.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010234000_admin_analytics.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010234000_admin_analytics.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010234000_admin_analytics.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251010235000_ai_cost_tracking.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW ai_cost_by_model IS 'AI cost breakdown by AI model';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251010235000_ai_cost_tracking.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251010235000_ai_cost_tracking.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251010235000_ai_cost_tracking.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251010235000_ai_cost_tracking.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251012005052_a8dfd754-bffa-4018-be76-dbc4ce9153af.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ALTER TABLE recipes 
  ...
  ADD COLUMN IF NOT EXISTS tips TEXT;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251012005052_a8dfd754-bffa-4018-be76-dbc4ce9153af.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251012005052_a8dfd754-bffa-4018-be76-dbc4ce9153af.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251012005052_a8dfd754-bffa-4018-be76-dbc4ce9153af.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251012005052_a8dfd754-bffa-4018-be76-dbc4ce9153af.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251012010642_b2a14d3a-766b-445d-9c2a-80487a3a452d.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$function$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251012010642_b2a14d3a-766b-445d-9c2a-80487a3a452d.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251012010642_b2a14d3a-766b-445d-9c2a-80487a3a452d.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251012010642_b2a14d3a-766b-445d-9c2a-80487a3a452d.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251012010642_b2a14d3a-766b-445d-9c2a-80487a3a452d.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251012011805_60cf5942-6c7c-4215-9b4c-14085bfb21cd.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$function$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251012011805_60cf5942-6c7c-4215-9b4c-14085bfb21cd.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251012011805_60cf5942-6c7c-4215-9b4c-14085bfb21cd.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251012011805_60cf5942-6c7c-4215-9b4c-14085bfb21cd.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251012011805_60cf5942-6c7c-4215-9b4c-14085bfb21cd.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013042658_25106cb6-71d7-4bfe-acba-f0b0f1126dc6.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
$function$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013042658_25106cb6-71d7-4bfe-acba-f0b0f1126dc6.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013042658_25106cb6-71d7-4bfe-acba-f0b0f1126dc6.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013042658_25106cb6-71d7-4bfe-acba-f0b0f1126dc6.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013042658_25106cb6-71d7-4bfe-acba-f0b0f1126dc6.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013045657_076d6c6b-a25a-4267-a04d-fdbccbca1761.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
END$$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013045657_076d6c6b-a25a-4267-a04d-fdbccbca1761.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013045657_076d6c6b-a25a-4267-a04d-fdbccbca1761.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013045657_076d6c6b-a25a-4267-a04d-fdbccbca1761.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013045657_076d6c6b-a25a-4267-a04d-fdbccbca1761.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013120000_admin_live_activity.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE admin_system_health IS 'System performance and health metrics over time';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013120000_admin_live_activity.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013120000_admin_live_activity.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013120000_admin_live_activity.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013120000_admin_live_activity.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013130000_feature_flags.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION get_user_feature_flags IS 'Returns all feature flags for a user with their enabled status';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013130000_feature_flags.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013130000_feature_flags.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013130000_feature_flags.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013130000_feature_flags.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013140000_support_tickets.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE ticket_canned_responses IS 'Pre-written response templates for admins';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013140000_support_tickets.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013140000_support_tickets.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013140000_support_tickets.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013140000_support_tickets.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013150000_blog_uniqueness_tracking.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION get_blog_generation_insights IS 'Provides insights on blog generation patterns and suggestions';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013150000_blog_uniqueness_tracking.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013150000_blog_uniqueness_tracking.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013150000_blog_uniqueness_tracking.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013150000_blog_uniqueness_tracking.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013151257_424570f3-724f-4764-95f4-d3c9e69fd802.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE INDEX idx_referral_rewards_status ON referral_rewards(status);
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013151257_424570f3-724f-4764-95f4-d3c9e69fd802.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013151257_424570f3-724f-4764-95f4-d3c9e69fd802.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013151257_424570f3-724f-4764-95f4-d3c9e69fd802.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013151257_424570f3-724f-4764-95f4-d3c9e69fd802.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013151526_580c4971-9431-4611-85fc-128e1a38384a.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
ALTER TABLE referrals ADD CONSTRAINT referrals_referred_user_id_fkey 
  FOREIGN KEY (referred_user_id) REFERENCES profiles(id) ON DELETE CASCADE;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013151526_580c4971-9431-4611-85fc-128e1a38384a.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013151526_580c4971-9431-4611-85fc-128e1a38384a.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013151526_580c4971-9431-4611-85fc-128e1a38384a.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013151526_580c4971-9431-4611-85fc-128e1a38384a.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013152646_d3831937-3780-46d0-8181-ea66061ae2cf.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE INDEX idx_waitlist_joined_at ON public.waitlist(joined_at DESC);
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013152646_d3831937-3780-46d0-8181-ea66061ae2cf.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013152646_d3831937-3780-46d0-8181-ea66061ae2cf.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013152646_d3831937-3780-46d0-8181-ea66061ae2cf.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013152646_d3831937-3780-46d0-8181-ea66061ae2cf.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013160000_email_sequences.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE user_email_sequences IS 'Tracks user enrollment in email sequences';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013160000_email_sequences.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013160000_email_sequences.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013160000_email_sequences.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013160000_email_sequences.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013170000_enhanced_lead_scoring.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION get_lead_score_breakdown IS 'Returns detailed breakdown of how a lead score is calculated';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013170000_enhanced_lead_scoring.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013170000_enhanced_lead_scoring.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013170000_enhanced_lead_scoring.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013170000_enhanced_lead_scoring.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251013172257_e84cfccc-4de5-4580-b63b-7e78c19590df.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
  ...
  USING (
    EXISTS (
      ...
      AND store_layouts.user_id = auth.uid()
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251013172257_e84cfccc-4de5-4580-b63b-7e78c19590df.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251013172257_e84cfccc-4de5-4580-b63b-7e78c19590df.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251013172257_e84cfccc-4de5-4580-b63b-7e78c19590df.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251013172257_e84cfccc-4de5-4580-b63b-7e78c19590df.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251014000000_grocery_recipe_phase1.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN grocery_items.added_via IS 'How this item was added (manual, recipe, restock, etc.)';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251014000000_grocery_recipe_phase1.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251014000000_grocery_recipe_phase1.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251014000000_grocery_recipe_phase1.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251014000000_grocery_recipe_phase1.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251014000001_grocery_recipe_phase1_fixed.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
END $$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251014000001_grocery_recipe_phase1_fixed.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251014000001_grocery_recipe_phase1_fixed.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251014000001_grocery_recipe_phase1_fixed.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251014000001_grocery_recipe_phase1_fixed.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251014000002_grocery_recipe_phase1_final.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
END $$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251014000002_grocery_recipe_phase1_final.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251014000002_grocery_recipe_phase1_final.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251014000002_grocery_recipe_phase1_final.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251014000002_grocery_recipe_phase1_final.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251014000003_grocery_recipe_phase1_complete.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
END $$;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251014000003_grocery_recipe_phase1_complete.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251014000003_grocery_recipe_phase1_complete.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251014000003_grocery_recipe_phase1_complete.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251014000003_grocery_recipe_phase1_complete.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251029033504_b10a66ba-0f5b-419d-b82a-e549ab46a733.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
IS 'Updates blog_posts.content if caller is admin (bypasses RLS via SECURITY DEFINER). Used by internal linking approvals.';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251029033504_b10a66ba-0f5b-419d-b82a-e549ab46a733.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251029033504_b10a66ba-0f5b-419d-b82a-e549ab46a733.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251029033504_b10a66ba-0f5b-419d-b82a-e549ab46a733.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251029033504_b10a66ba-0f5b-419d-b82a-e549ab46a733.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251030000000_add_stripe_price_ids.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN subscription_plans.stripe_price_id IS 'DEPRECATED: Use stripe_price_id_monthly or stripe_price_id_yearly instead';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251030000000_add_stripe_price_ids.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251030000000_add_stripe_price_ids.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251030000000_add_stripe_price_ids.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251030000000_add_stripe_price_ids.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251030000001_subscription_enhancements.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
GRANT SELECT ON user_subscription_dashboard TO authenticated;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251030000001_subscription_enhancements.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251030000001_subscription_enhancements.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251030000001_subscription_enhancements.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251030000001_subscription_enhancements.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251103000000_create_seo_management_tables.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE seo_monitoring_log IS 'Automated monitoring event log';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251103000000_create_seo_management_tables.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251103000000_create_seo_management_tables.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251103000000_create_seo_management_tables.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251103000000_create_seo_management_tables.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251104000000_google_search_console_integration.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE gsc_sync_log IS 'Log of GSC data synchronization events';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251104000000_google_search_console_integration.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251104000000_google_search_console_integration.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251104000000_google_search_console_integration.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251104000000_google_search_console_integration.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251105000000_seo_automated_monitoring.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
-- =====================================================
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251105000000_seo_automated_monitoring.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251105000000_seo_automated_monitoring.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251105000000_seo_automated_monitoring.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251105000000_seo_automated_monitoring.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251106000000_advanced_seo_features.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
-- =============================================
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251106000000_advanced_seo_features.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251106000000_advanced_seo_features.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251106000000_advanced_seo_features.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251106000000_advanced_seo_features.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251107000000_enterprise_seo_features.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE seo_performance_budget IS 'Performance budget monitoring - page size, requests, resources';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251107000000_enterprise_seo_features.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251107000000_enterprise_seo_features.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251107000000_enterprise_seo_features.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251107000000_enterprise_seo_features.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251107000000_fix_complementary_subscriptions.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW user_subscription_dashboard IS 'Comprehensive view of user subscriptions including complementary access';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251107000000_fix_complementary_subscriptions.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251107000000_fix_complementary_subscriptions.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251107000000_fix_complementary_subscriptions.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251107000000_fix_complementary_subscriptions.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251107100000_unified_search_traffic_analytics.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE traffic_forecasts IS 'Predicted future traffic based on historical data';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251107100000_unified_search_traffic_analytics.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251107100000_unified_search_traffic_analytics.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251107100000_unified_search_traffic_analytics.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251107100000_unified_search_traffic_analytics.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251108000000_content_optimization_features.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN seo_semantic_analysis.intent_signals IS 'Search intent classification and optimization tips';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251108000000_content_optimization_features.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251108000000_content_optimization_features.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251108000000_content_optimization_features.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251108000000_content_optimization_features.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251109000000_user_intelligence_dashboard.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION search_users_intelligence(TEXT, TEXT, INTEGER) IS 'Search users with optional filters (at_risk, payment_failed, has_tickets, churned, vip)';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251109000000_user_intelligence_dashboard.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251109000000_user_intelligence_dashboard.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251109000000_user_intelligence_dashboard.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251109000000_user_intelligence_dashboard.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251109000001_smart_support_copilot.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION search_kb_articles(TEXT, TEXT, INTEGER) IS 'Full-text search across knowledge base articles';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251109000001_smart_support_copilot.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251109000001_smart_support_copilot.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251109000001_smart_support_copilot.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251109000001_smart_support_copilot.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251109000002_revenue_operations_command_center.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION schedule_payment_retry(UUID, UUID, NUMERIC, TEXT) IS 'Schedule smart payment retry with exponential backoff (3d, 7d, 14d)';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251109000002_revenue_operations_command_center.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251109000002_revenue_operations_command_center.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251109000002_revenue_operations_command_center.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251109000002_revenue_operations_command_center.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251109000003_fix_user_roles_rls.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
  ...
  USING (
    EXISTS (
      ...
      AND ur.role = 'admin'::app_role
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251109000003_fix_user_roles_rls.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251109000003_fix_user_roles_rls.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251109000003_fix_user_roles_rls.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251109000003_fix_user_roles_rls.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000000_picky_eater_quiz.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE quiz_referrals IS 'Referral program tracking and reward management';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000000_picky_eater_quiz.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000000_picky_eater_quiz.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000000_picky_eater_quiz.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000000_picky_eater_quiz.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000001_budget_calculator_meal_planner.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON TABLE tool_analytics IS 'Unified analytics tracking for all lead magnet tools';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000001_budget_calculator_meal_planner.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000001_budget_calculator_meal_planner.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000001_budget_calculator_meal_planner.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000001_budget_calculator_meal_planner.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000001_meal_plan_templates.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION calculate_template_success_rate IS 'Calculates average success rate for meals created from a template';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000001_meal_plan_templates.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000001_meal_plan_templates.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000001_meal_plan_templates.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000001_meal_plan_templates.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000002_push_notifications.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION should_send_notification IS 'Checks if notification should be sent based on user preferences';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000002_push_notifications.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000002_push_notifications.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000002_push_notifications.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000002_push_notifications.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000003_recipe_scaling.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON VIEW recipe_scaling_info IS 'Quick view of recipe scaling capabilities';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000003_recipe_scaling.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000003_recipe_scaling.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000003_recipe_scaling.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000003_recipe_scaling.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000004_meal_voting.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION check_voting_achievements IS 'Checks and awards achievements based on voting activity';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000004_meal_voting.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000004_meal_voting.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000004_meal_voting.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000004_meal_voting.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000005_weekly_reports.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION save_report_trend IS 'Saves a metric value for trend tracking';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000005_weekly_reports.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000005_weekly_reports.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000005_weekly_reports.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000005_weekly_reports.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000006_meal_suggestions.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION get_kid_favorite_recipes IS 'Returns recipes with high kid approval scores';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000006_meal_suggestions.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000006_meal_suggestions.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000006_meal_suggestions.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000006_meal_suggestions.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251110000007_grocery_delivery.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON FUNCTION update_order_status IS 'Updates order status and records in history';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251110000007_grocery_delivery.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251110000007_grocery_delivery.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251110000007_grocery_delivery.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251110000007_grocery_delivery.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251111000000_add_custom_domains.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
COMMENT ON COLUMN professional_brand_settings.primary_color IS 'Primary brand color in hex format';
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251111000000_add_custom_domains.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251111000000_add_custom_domains.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251111000000_add_custom_domains.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251111000000_add_custom_domains.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251113000000_performance_indexes.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
-- ORDER BY pg_relation_size(indexrelid) DESC;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251113000000_performance_indexes.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251113000000_performance_indexes.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251113000000_performance_indexes.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251113000000_performance_indexes.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251124000000_fix_household_members_recursion.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
GRANT EXECUTE ON FUNCTION public.user_belongs_to_household(uuid, uuid) TO anon;
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251124000000_fix_household_members_recursion.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251124000000_fix_household_members_recursion.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251124000000_fix_household_members_recursion.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251124000000_fix_household_members_recursion.sql';
    END IF;
END $$;
...
BEGIN
    -- Check if migration already applied
    IF NOT EXISTS (SELECT 1 FROM _migrations WHERE filename = '20251202000000_blog_publishing_editor.sql' AND success = true) THEN
        -- Apply migration
        BEGIN
...
CREATE TRIGGER update_prompt_templates_updated_at
  ...
  EXECUTE FUNCTION update_updated_at_column();
            ...
            -- Record successful migration
            INSERT INTO _migrations (filename, success) VALUES ('20251202000000_blog_publishing_editor.sql', true);
        EXCEPTION WHEN OTHERS THEN
            -- Record failed migration
            INSERT INTO _migrations (filename, success, error_message) VALUES ('20251202000000_blog_publishing_editor.sql', false, SQLERRM);
            RAISE NOTICE 'Migration failed: % - Error: %', '20251202000000_blog_publishing_editor.sql', SQLERRM;
        END;
    ELSE
        RAISE NOTICE 'Skipping already applied migration: %', '20251202000000_blog_publishing_editor.sql';
    END IF;
END $$;
...
BEGIN
    SELECT COUNT(*) INTO total_count FROM _migrations;
    SELECT COUNT(*) INTO success_count FROM _migrations WHERE success = true;
    SELECT COUNT(*) INTO failed_count FROM _migrations WHERE success = false;
