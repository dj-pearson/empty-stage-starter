...
// Mock window.matchMedia. Guarded so a file that opts into the node
// environment (// @vitest-environment node, e.g. the App Store WebCrypto
// mirrors) can still load this setup.
