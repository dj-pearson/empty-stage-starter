...
const SolutionPage = () => {
  ...
  const seoProps = getPageSEOProps(pageData, "solution");
  ...
  const structuredData = [
    generateBreadcrumbData([
      ...
      { name: pageData.headline, url: `${baseUrl}/solutions/${pageData.slug}` },
    ]),
    generateFAQStructuredData(pageData.faqs),
    {
      "@type": "WebPage",
      "@id": `${baseUrl}/solutions/${pageData.slug}#webpage`,
      url: `${baseUrl}/solutions/${pageData.slug}`,
      name: pageData.title,
  ...
  // Build related pages data from both features and solutions
  const relatedPagesData = pageData.relatedPages
    .map((slug) => {
      const relatedFeature = featurePages[slug];
      const relatedSolution = solutionPages[slug];
      const related = relatedFeature || relatedSolution;
      if (!related) return null;
      const type = relatedFeature ? "features" : "solutions";
      return {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-4">
        <Breadcrumbs
          items={[
            ...
            { name: pageData.headline, href: `/solutions/${pageData.slug}` },
          ]}
        />
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            <Card className="border-destructive/30">
              ...
              <CardContent>
                <p className="text-muted-foreground">{pageData.problemStatement}</p>
              </CardContent>
            </Card>
            <Card className="border-primary/30">
              ...
              <CardContent>
                <p className="text-muted-foreground">{pageData.solution}</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div>
                <p className="font-semibold">{pageData.testimonial.author}</p>
                <p className="text-sm text-muted-foreground">
                  {pageData.testimonial.role}
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4">
        <RelatedPages
          title="Related Solutions & Features"
