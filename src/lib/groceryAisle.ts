/**
 * Name-to-unit suggestions for grocery items.
 *
 * US-720: ported out of app/mobile/lib/unit-suggestions.ts, which was the only
 * data in the retired Expo client worth keeping. US-728 grows this file into
 * the shared grocery aisle taxonomy; this is its seed.
 *
 * The table is ordered: the first pattern that matches a name wins, so the
 * specific entries (half and half, english muffin) sit above the general ones
