...
interface FeatureGateProps {
  ...
  /**
   * Heading level of the lock screen title. 1 (the default) when the gate is
   * the whole page; 2 when the page renders its own h1 above it (AICoach,
   * MealBuilder, FoodChaining).
   */
  headingLevel?: 1 | 2;
...
export function FeatureGate({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-4">
      ...
      {/*
        US-860: h1 by default, for a page whose whole body is this gate.
        AICoach, MealBuilder and FoodChaining render their own h1 (and, on
        FoodChaining, the kid chips) above the gate, so they pass
        headingLevel={2}.
      */}
